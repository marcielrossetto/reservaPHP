...
if (!empty($_POST['nome']) && !empty($_POST['senha'])) {
    ...
    $sql = $pdo->prepare("SELECT * FROM login WHERE nome = :nome AND senha = :senha");
    ...
    if ($sql->rowCount() > 0) {
        ...
        $erro = "Nome ou senha incorretos. Você não tem permissão para cadastrar Rodízio!";
    }
}
...
<head>
    ...
    <title>Senha para Cadastro de Rodízio</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Autenticação para Cadastrar Rodízio</h5>
            </div>
                ...
                <form method="POST">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input 
                            ...
                            id="senha" 
                            name="senha" 
                            placeholder="Digite a senha para cadastrar Rodízio." 
                            required 
                        />
                    </div>

...
<body>
    ...
    <div class="container-fluid mt-3">
            ...
            <form method="GET" class="row g-2 align-items-end">
                <div class="col-md-3 col-6">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="date" name="filtro_data" class="form-control" value="<?= $filtroData ?>"
                ...
                <div class="col-md-3 col-6">
                    ...
                    <input type="text" name="busca_texto" class="form-control form-control-sm" placeholder="Nome/Tel"
                        value="<?= htmlspecialchars($buscaTexto) ?>">
                </div>

                <div class="col-md-3 col-12">
                    <div class="btn-group w-100 btn-group-sm" role="group">
                        <button type="submit" name="periodo" value="todos"
                            class="btn btn-outline-secondary <?= $periodo == 'todos' ? 'active' : '' ?>">Todos</button>
                        <button type="submit" name="periodo" value="almoco"
                            class="btn btn-outline-secondary <?= $periodo == 'almoco' ? 'active' : '' ?>">Almoço</button>
                        <button type="submit" name="periodo" value="jantar"
                            class="btn btn-outline-secondary <?= $periodo == 'jantar' ? 'active' : '' ?>">Jantar</button>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-12">
                    <div class="mobile-btn-row">
                        <button type="button" onclick="window.print()" class="btn btn-secondary btn-sm w-100"><i
                                class="fas fa-print"></i> Imprimir</button>
                        <a href="adicionar_reserva.php" class="btn btn-success btn-sm w-100"><i class="fas fa-plus"></i>
                            Nova</a>
                    </div>
                </div>
            </form>
        ...
        <!-- RESUMO -->
        <div class="alert alert-secondary py-1 px-3 d-flex justify-content-between align-items-center no-print mb-3"
            ...
            <?php if (count($reservas) > 0): ?>
                <?php foreach ($reservas as $r):
                    ...
                    <div class="reserva-card <?= $classeBorda ?>">
                        <!-- Badge Desktop -->
                        <span
                            class="badge-status <?= $isConfirmado ? 'badge-ok' : 'badge-wait' ?>"><?= $isConfirmado ? 'Confirmado' : 'Pendente' ?></span>
                        ...
                        <div class="sec-actions">
                            ...
                            <a href="excluir_reserva.php?id=<?= $r['id'] ?>" class="btn-action"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="bg-light p-3 border-bottom d-flex justify-content-around text-center">
                        <div>
                            <h5 id="pTotal" class="m-0 fw-bold">0</h5><small class="text-muted">Reservas</small>
                        </div>
                        <div>
                            <h5 id="pCancel" class="m-0 fw-bold text-danger">0</h5><small
                                class="text-muted">Cancelou</small>
                        </div>
                        <div>
                            <h5 id="pPessoas" class="m-0 fw-bold text-success">0</h5><small
                                class="text-muted">Pessoas</small>
                        </div>
                    </div>
